...
import { validateUserRegistration, convertValidationErrors, ValidationResult } from '@/utils/validation';
...
export function RegisterForm({ onSwitchToLogin, redirectTo = '/' }: RegisterFormProps) {
  ...
  const validateForm = () => {
    const validationResult: ValidationResult = validateUserRegistration(formData);
