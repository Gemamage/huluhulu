...
export function FoundPetForm({
  ...
  const [formData, setFormData] = useState<FoundPetFormData>({
    ...
    finderContact: {
      ...
      ...(initialData?.finderContact?.email !== undefined && {
    ...
    ...(initialData?.estimatedAge !== undefined && {
    ...
    ...(initialData?.foundTime !== undefined && {
    ...
    ...(initialData?.behaviorNotes !== undefined && {
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={e =>
                    handleInputChange('estimatedAge', e.target.value)
                  }
                  className='w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500'
                >
                  <option value='unknown'>不確定</option>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <div>
                ...
                <Input
                  ...
                  className={
                    errors['finderContact.name'] ? 'border-red-500' : ''
                  }
                />
              ...
              <div>
                ...
                <Input
                  ...
                  className={
                    errors['finderContact.phone'] ? 'border-red-500' : ''
                  }
                />
            ...
            <div className='space-y-4'>
              <div className='flex items-center space-x-2'>
                <input
                  ...
                  onChange={e =>
                    handleInputChange('hasCollar', e.target.checked)
                  }
              ...
              <div className='flex items-center space-x-2'>
                <input
                  ...
                  onChange={e =>
                    handleInputChange('isInjured', e.target.checked)
                  }
                  className='rounded border-gray-300'
                />
