        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <Input
              ...
              onChange={(e) => onInputChange('ownerContact', {
            ...
            {errors['ownerContact.name'] && (
              <p className="text-red-500 text-sm mt-1">{errors['ownerContact.name']}</p>
            )}
          </div>
          ...
          <div>
            ...
            {errors['ownerContact.phone'] && (
              <p className="text-red-500 text-sm mt-1">{errors['ownerContact.phone']}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            {errors['ownerContact.email'] && (
              <p className="text-red-500 text-sm mt-1">{errors['ownerContact.email']}</p>
            )}
          </div>
          ...
          <div>
            ...
            <Select 
              ...
              onValueChange={(value) => onInputChange('ownerContact', {
                ...formData.ownerContact,
