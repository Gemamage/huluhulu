        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <Input
              ...
              onChange={(e) => onInputChange('reward', e.target.value ? Number(e.target.value) : undefined)}
              onBlur={(e) => onFieldBlur('reward', e.target.value ? Number(e.target.value) : undefined)}
