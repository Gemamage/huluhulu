      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            />
            {errors.lostDate && <p className="text-red-500 text-sm mt-1">{errors.lostDate}</p>}
          </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
            <Input
              ...
              onChange={(e) => onInputChange('lostLocation', {
            ...
            <Input
              ...
              className={errors['lostLocation.district'] ? 'border-red-500' : ''}
            />
            <Input
              placeholder="詳細地址"
          ...
          {(errors['lostLocation.city'] || errors['lostLocation.district'] || errors['lostLocation.address']) && (
