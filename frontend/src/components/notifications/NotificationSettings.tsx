...
export const NotificationSettings: React.FC<NotificationSettingsProps> = ({
  ...
  const handleChannelToggle = (channel: 'push' | 'email' | 'sms', enabled: boolean) => {
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleTypeToggle('pet_match', checked)}
                disabled={updating || !preferences.enabled}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleTypeToggle('pet_found', checked)}
                disabled={updating || !preferences.enabled}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleTypeToggle('pet_lost', checked)}
                disabled={updating || !preferences.enabled}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleTypeToggle('geofence', checked)}
                disabled={updating || !preferences.enabled}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => handleTypeToggle('reminder', checked)}
                disabled={updating || !preferences.enabled}
              />
            </div>
