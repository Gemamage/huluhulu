...
import { BarChart3, Bell, CheckCircle, Clock, AlertTriangle } from 'lucide-react';
...
export const NotificationStats: React.FC = () => {
  ...
  const readPercentage = stats.totalCount > 0 
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-medium text-muted-foreground">已讀通知</p>
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="flex items-center justify-between py-2">
              <span className="text-sm text-muted-foreground">今日收到通知</span>
              <Badge variant="outline">{stats.todayCount} 條</Badge>
            </div>
            <div className="flex items-center justify-between py-2">
              <span className="text-sm text-muted-foreground">本週收到通知</span>
              <Badge variant="outline">{stats.weekCount || 0} 條</Badge>
            </div>
            <div className="flex items-center justify-between py-2">
              <span className="text-sm text-muted-foreground">本月收到通知</span>
              <Badge variant="outline">{stats.monthCount || 0} 條</Badge>
            </div>
            <div className="flex items-center justify-between py-2">
              <span className="text-sm text-muted-foreground">最後更新時間</span>
