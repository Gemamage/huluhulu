            ...
            <CardContent>
              ...
              <div className="mt-4 p-3 bg-amber-50 rounded-lg border border-amber-200">
                <p className="text-sm text-amber-800">
                  <strong>緊急情況：</strong>如遇寵物緊急狀況，請直接撥打當地動物醫院或動保處電話。
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3 text-sm">
                <div>
                  <p className="font-medium text-gray-900">Q: 如何發布走失寵物資訊？</p>
                  <p className="text-gray-600">A: 點擊首頁的「我的寵物走失了」按鈕，填寫詳細資訊即可發布。</p>
                </div>
                
                <div>
                  <p className="font-medium text-gray-900">Q: 發現走失寵物該怎麼辦？</p>
                  <p className="text-gray-600">A: 請點擊「我發現了寵物」填寫拾獲通報，幫助寵物回家。</p>
                </div>
                
                <div>
                  <p className="font-medium text-gray-900">Q: 網站服務是免費的嗎？</p>
                  <p className="text-gray-600">A: 是的，我們提供完全免費的寵物協尋服務。</p>
                </div>
              </div>
            </CardContent>
          </Card>
