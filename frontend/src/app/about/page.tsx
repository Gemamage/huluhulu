          ...
          <div className='max-w-4xl mx-auto'>
            <div className='text-center mb-12'>
              ...
              <p className='text-lg text-zinc-600 max-w-3xl mx-auto mb-8'>
                「<span className='text-primary font-semibold'>呼嚕</span>
                」是生命最深沉、最安心的共鳴。我們致力於守護這份代表「
                <span className='text-primary font-semibold'>家</span>
                」的安心頻率。
              </p>
            </div>
            ...
            <div className='bg-white rounded-2xl shadow-lg p-8 mb-12'>
              <p className='text-lg text-gray-700 leading-relaxed mb-6'>
                「呼嚕
                (Hūlū)」是一個專為台灣地區設計的寵物協尋平台，透過地理位置定位、AI
                圖像識別和社群協作功能，幫助失蹤寵物與主人快速重聚。
              </p>
              <p className='text-lg text-gray-700 leading-relaxed mb-6'>
                我們秉持「
                <span className='font-semibold text-primary'>守護安心頻率</span>
                」的核心價值，目標是在寵物失蹤的黃金 72
                小時內，最大化尋回成功率。
              </p>
